...
public class StoreList {
    ...
    public ArrayList<Store> createDefaultArr() {
        ...
        Store ChessStore = new Store("Chess Store", "123 Bluebird St", "67226", 30, null);
        Store GameStore = new Store("Game Store", "187 Yellow Ave", "13143", 50, null);
        Store CardStore = new Store("Card Store", "900 Sandpiper Ln", "39507", 40, null);
